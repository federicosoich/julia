<?php
class Aguaverde_Chatbot_Block_Message_Commands extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
	...
	protected function _getRendererEnableCase()
	{
		if (!$this->_itemRendererEnableCase)
		{
			...
			$this->_itemRendererEnableCase->setExtraParams("onChange='aguaverdeTogleEnable(this)'");
		}
