...
// class that handles all Facebook requests.
	require_once("MessengerBot.php");

	class Aguaverde_Chatbot_Model_Api_Facebook_Handler extends Aguaverde_Chatbot_Model_Chatdata
	{
		public $_facebook;
		...
		public function _construct()
		{
			...
			$this->_chatbotHelper = Mage::helper('aguaverde_chatbot');
		}
		...
		public function facebookHandler()
		{
			...
			$hubToken = Mage::getStoreConfig('chatbot_enable/general_config/your_custom_key');
     		Mage::log("hubToken:\n" . var_export($hubToken, true) . "\n\n", null, 'chatbot_facebook_hubToken.log');

			$verify = $facebook->verifyWebhook($hubToken);
     		Mage::log("verify:\n" . var_export($verify, true) . "\n\n", null, 'chatbot_facebook_verify.log');
